...
const handler = async (req, res) => {
  try {
    ...
    const msg = {
      ...
      html: `<body style="margin: 0; padding: 0;"><div style="background: #f1f5f9; padding-top: 30px; padding-bottom: 30px; padding-right: 16px; padding-left: 16px;"><div style="background: #fff; border-radius: 10px; padding: 24px; max-width: 440px; margin: auto;"><p style="margin-top: 10px; font-size: 22px; color:#374151; font-weight: bold; text-align: center;">Reset Password</p><p style="font-size: 14px; color: #6b7280;">Dear ${name},</p><p style="font-size: 14px; color: #6b7280; margin-bottom: 50px;">You are receiving this email because we received a password reset request for your account. If you did not request a password reset, no further action is required.</p><div style="height:50px; text-align:center;"><a style="padding: 14px 40px; font-size: 14px; border-radius: 10px; background: #7c3aed; color: #ffffff !important; text-decoration: none;" href="https://pryzma.io/reset-password/${magicLink}">Reset Password</a></div><p style="font-size: 14px; color: #6b7280;">Thanks,</p><p style="font-size: 14px; color: #6b7280;">The Pryzma Team</p></div></div></body>`,
    };
