      ...
      <div className="mx-auto max-w-7xl p-4 pt-20 pb-20 flex items-center justify-between">
        ...
        <div className="w-1/2 bg-gray-100 rounded-lg shadow-xl shadow-gray-300 overflow-hidden">
          <div className="rounded-lg">
            <div>
              <p className=" text-violet-400 font-medium text-lg p-5 pl-8 pr-8 bg-gray-800 flex items-center">
                <PersonCheck className="text-2xl mr-4"/>Company Profile for AAPL
              </p>
              <div>
              ...
              <p className="pt-2 text-sm leading-6 flex p-3 pr-8 pl-8">
