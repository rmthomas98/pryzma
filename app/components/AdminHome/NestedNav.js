    ...
    <div className="bg-gray-800 max-w-[230px] w-full h-screen overflow-auto sticky top-0 flex flex-col">
        ...
        <a
          ...
          className={`${
            router.pathname.endsWith("/admin")
              ...
              : "opacity-60"
          } text-white text-xs p-2 pl-4 relative mt-3 hover:opacity-100 hover:bg-gray-900 duration-200 transition-all flex items-center`}
        >
          <span
            className={`${
      ...
      <Link href="/admin/overview">
        <a
          ...
          className={`text-white text-xs p-2 pl-4 flex items-center relative hover:opacity-100 duration-200 hover:bg-gray-900 transition-all ${
      ...
      <Link href="/admin/offerings">
        <a
          ...
          className={`text-white text-xs p-2 pl-4 relative flex items-center hover:bg-gray-900 hover:opacity-100 transition-all duration-200 ${
          ...
          <span
            className={`${
              number === 7 || router.pathname.endsWith("/offerings")
                ? "h-full"
                : "h-0"
            } absolute h-0 origin-center transition-all duration-200 content-none left-0 bottom-0 ease-in my-auto top-0 w-0.5 rounded-full bg-indigo-400`}
          ></span>
      ...
      <Link href="/admin/income">
        <a
          ...
          className={`text-white text-xs p-2 pl-4 hover:bg-gray-900 hover:opacity-100 trasnition-all duration-200 flex relative items-center ${
      ...
      <Link href="/admin/balance">
        <a
          ...
          className={`text-white text-xs p-2 pl-4 relative hover:bg-gray-900 hover:opacity-100 transition-all duration-200 flex items-center ${
      ...
      <Link href="/admin/insiders">
        <a
          ...
          className={`text-white mb-10 text-xs p-2 pl-4 relative flex items-center hover:bg-gray-900 hover:opacity-100 transition-all duration-200 ${
