    ...
    <div className="bg-gray-800 max-w-[230px] w-full h-screen overflow-auto sticky top-0 flex flex-col">
      ...
      <Link href="/">
        <a
          ...
          } text-white text-sm p-3 pl-4 relative mt-3 hover:opacity-100 hover:bg-gray-900 duration-200 transition-all flex items-center`}
        >
          <span
            className={`${
      ...
      <Link href="/admin/overview">
        <a  onMouseEnter={() => setNumber(2)}
          ...
          } className={`text-white text-sm p-3 pl-4 flex items-center relative hover:opacity-100 duration-200 hover:bg-gray-900 transition-all ${router.pathname.endsWith('/overview') ? 'bg-gray-900 opacity-100' : 'opacity-60'}`}> <span
            className={`${
