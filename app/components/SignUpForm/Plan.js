...
const Plan = ({increment, email}) => {
  ...
  const handleButtonClick = async (e) => {
    ...
    const response = await axios.post('/api/create-subscription', {priceId: e.target.value, email: email.current, plan: plan.current}).catch(e => console.error(e));
  ...
  return (
    <div className='opacity-0 animate-fadeIn'>
      {errorMessage && (
        <div className="mt-10 mx-auto w-full max-w-[300px] absolute top-[40px] left-1/2 translate-x-[-50%] p-4 pt-6 pb-6 bg-rose-800 border-2 border-rose-400 rounded-lg shadow-lg shadow-gray-900/75">
      ...
      <div className="w-full mr-6 bg-gray-100 shadow-lg shadow-gray-300 rounded-lg p-6">
        ...
        <p className='flex items-center mt-6'><Check className='text-indigo-600 text-lg mr-2'/><span className='text-gray-800'>SEC Filings</span></p>
        <p className='flex items-center'><Check className='text-indigo-600 text-lg mr-2'/><span className='text-gray-800'>Real Time Quotes</span></p>
        <p className='flex items-center'><Check className='text-indigo-600 text-lg mr-2'/><span className='text-gray-800'>Key Statistics</span></p>
        <p className='flex items-center'><Check className='text-indigo-600 text-lg mr-2'/><span className='text-gray-800'>Financials</span></p>
        <p className='flex items-center mb-10'><Check className='text-indigo-600 text-lg mr-2'/><span className='text-gray-800'>Latest News</span></p>
      ...
      <div className="w-full bg-gray-100 shadow-lg shadow-gray-300 rounded-lg p-6 relative overflow-hidden">
        ...
        <p className='text-center flex items-center mt-6'><Check className='text-indigo-600 text-lg mr-2'/><span className='text-gray-800'>SEC Filings</span></p>
        <p className='flex items-center'><Check className='text-indigo-600 text-lg mr-2'/><span className='text-gray-800'>Real Time Quotes</span></p>
        <p className='flex items-center'><Check className='text-indigo-600 text-lg mr-2'/><span className='text-gray-800'>Key Statistics</span></p>
        <p className='flex items-center'><Check className='text-indigo-600 text-lg mr-2'/><span className='text-gray-800'>Financials</span></p>
        <p className='flex items-center mb-10'><Check className='text-indigo-600 text-lg mr-2'/><span className='text-gray-800'>Latest News</span></p>
